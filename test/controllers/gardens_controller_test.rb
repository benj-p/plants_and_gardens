...
class GardensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create garden" do
    assert_difference('Garden.count') do
      post gardens_url, params: { garden: { anner_url: @garden.anner_url, nameb: @garden.nameb } }
    end
  ...
  test "should update garden" do
    patch garden_url(@garden), params: { garden: { anner_url: @garden.anner_url, nameb: @garden.nameb } }
